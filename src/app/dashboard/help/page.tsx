...
export default function HelpPage() {
    ...
    return (
        <div className="flex h-screen bg-[#f5f6f8]">
            <DashboardSidebar />
            <main className="flex-1 overflow-y-auto relative bg-[#f5f6f8]">
                <style dangerouslySetInnerHTML={{ __html: `
                    ...
                    .nav-item { display: flex; align-items: center; padding: 12px 20px; color: #6b7280; text-decoration: none; transition: all .2s; font-size: 14px; font-weight: 500; cursor: pointer; }
